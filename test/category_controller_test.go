...
func setupTestDB() *sql.DB {
	connStr := "postgres://postgres:@localhost:5432/golang_restful_api_test?sslmode=disable"
...
func TestGetCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories/1000", nil)
	request.Header.Add("X-API-Key", "secret")
...
func TestDeleteCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:3000/api/categories/1000", nil)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "secret")
...
func TestUnauthorized(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories", nil)
	request.Header.Add("X-API-Key", "secret-number")
